...
<html>
<head>
    <title>My App | Tabel Pasien</title>
...
<div class="container">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a href="pasien.php" class="nav-link btn-custom" aria-current="page">Pasien</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="row">
        <div class="col">
            <a href="tambahpasien.php" class="btn btn-tambah-data btn-sm d-flex">Tambah Data Pasien</a>
        </div>
    </div>
    <div class="row mt-3">
        <div class="col">
            <table class="table table-custom">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="hapuspasien.php?idPasien=<?= $row['idPasien']; ?>" class="btn btn-danger btn-sm">Hapus</a>
                    </td>
                </tr>
                <?php } ?>
            </table>
